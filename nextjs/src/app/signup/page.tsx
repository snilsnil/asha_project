...
export default function SignupForm() {
  ...
  return loading ? (
    <div className="text-center py-12 text-xl text-white bg-black min-h-screen">
      now loading...
    </div>
  ) : (
    <form
    ...
    >
      ...
      <div className="text-sm">
        <p className={checkPassword() ? 'text-green-400' : 'text-red-500'}>
          {password1 === ''
        ...
        <p
          className={
            password1 === password2 ? 'text-green-400' : 'text-red-500'
          }
        >
          {password2 === ''
            ? '비밀번호 확인을 입력하세요.'
